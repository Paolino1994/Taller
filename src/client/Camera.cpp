...
void Camera::renderMiniCamera(){
	...
	if (followed_y < YAML::MINIMAP_HEIGHT - 50) pos_y = 0;
		else {
			if (followed_y > 750) pos_y = 90;
				else pos_y = miniFieldRect->getPosY() - 20 + followed_y * (0.142857);
		}
	...
	if (followed_x < 185) pos_x = miniFieldRect->getPosX();
			...
			if(followed_x > 1484) pos_x = miniFieldRect->getPosX() + 190;
				else pos_x = miniFieldRect->getPosX() - 25 + followed_x * (0.147059);
		}
